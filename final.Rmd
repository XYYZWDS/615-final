...
img <- readPNG("C:/Users/xiaoy/Desktop/615 R/final/123.png")
...
data <- read.csv("C:/Users/xiaoy/Desktop/615 R/final/Northern Cyprus/API_CYP_DS2_en_csv_v2_6260326.csv", skip=4)
...
```{r}
cyprus_data <- read.csv("C:/Users/xiaoy/Desktop/615 R/final/Northern Cyprus/API_CYP_DS2_en_csv_v2_6260326.csv", skip = 4)
greece_data <- read.csv("C:/Users/xiaoy/Desktop/615 R/final/Greece//API_GRC_DS2_en_csv_v2_6230020.csv", skip = 4)
...
")
  ...
  output$mapPlot <- renderPlot({
   img1 <- readPNG("C:/Users/xiaoy/Desktop/615 R/final/124.png")
   plot(1:2, type = "n", main = "PNG Image")
